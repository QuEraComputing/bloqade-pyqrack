...
class PyQrackMethods(interp.MethodTable):
    ...
    def csx(self, interp: interp.Interpreter, frame: interp.Frame, stmt: uop.CSX):
        qarg: PyQrackQubit["QrackSimulator"] = frame.get(stmt.qarg)
        ctrl: PyQrackQubit["QrackSimulator"] = frame.get(stmt.ctrl)
    ...
    def swap(self, interp: interp.Interpreter, frame: interp.Frame, stmt: uop.Swap):
        qarg1: PyQrackQubit["QrackSimulator"] = frame.get(stmt.ctrl)
        qarg2: PyQrackQubit["QrackSimulator"] = frame.get(stmt.qarg)
    ...
    def cswap(self, interp: interp.Interpreter, frame: interp.Frame, stmt: uop.CSwap):
        qarg1: PyQrackQubit["QrackSimulator"] = frame.get(stmt.qarg1)
        qarg2: PyQrackQubit["QrackSimulator"] = frame.get(stmt.qarg2)
        ctrl: PyQrackQubit["QrackSimulator"] = frame.get(stmt.ctrl)
        if qarg1.is_active() and qarg2.is_active():
    ...
    def ccx(self, interp: interp.Interpreter, frame: interp.Frame, stmt: uop.CCX):
        ctrl1: PyQrackQubit["QrackSimulator"] = frame.get(stmt.ctrl1)
        ctrl2: PyQrackQubit["QrackSimulator"] = frame.get(stmt.ctrl2)
        qarg: PyQrackQubit["QrackSimulator"] = frame.get(stmt.qarg)
    ...
    def rxx(self, interp: interp.Interpreter, frame: interp.Frame, stmt: uop.RXX):
        a: PyQrackQubit["QrackSimulator"] = frame.get(stmt.qarg)
        b: PyQrackQubit["QrackSimulator"] = frame.get(stmt.ctrl)
